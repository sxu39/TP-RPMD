...
PairStyle(deepmdnew, PairDeepMDNew)

#else

#ifndef LMP_PAIR_NNP_NEW_H
#define LMP_PAIR_NNP_NEW_H
...
class PairDeepMDNew : public Pair {
 public:
  PairDeepMDNew(class LAMMPS *);
  ~PairDeepMDNew() override;
